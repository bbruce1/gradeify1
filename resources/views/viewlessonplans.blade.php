...
<!-- Page Wrapper -->
            <div class="page-wrapper">
                <div class="content container-fluid">
					...
					<div class="row">
						<div class="col-sm-12">
									<form action="/lessonplans/{{$id}}" method="POST">
                                        @csrf
										<div class="row">
											<div class="col-12">
											...
											<div class="col-12 col-sm-6">
												<div class="form-group">
                                                    ...
                                                    <textarea rows="4" cols="20" class="form-control summernote " placeholder="Enter your message here" name="lesson_plan">{{ $subject->lesson_plan }}</textarea>
											...
											<div class="col-12 mb-3">
												...
												{{-- <button type="submit" class="btn btn-primary">Finish</button> --}}
                                                    ...
                                                    <button type="submit" class="btn btn-danger" id="reset" value="reset" name="reset"> reset </button>
											</div>
										</div>
									</form>
								</div>
